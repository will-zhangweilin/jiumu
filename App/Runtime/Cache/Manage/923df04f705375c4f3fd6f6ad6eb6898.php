...
<body>
<div class="main">
    <div class="pos">添加联动分组</div>
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="<?php echo U('Itemgroup/add');?>">
		<dl>
			<dt>组名：</dt>
			<dd>
				<input type="text" name="remark" class="inp_one" />
			</dd>
		</dl>
		<dl>
			<dt>英文组名：</dt>
			<dd>
				<input type="text" name="name" class="inp_one" /><span class="tip">英文字母|拼音</span> 
			</dd>
		</dl>
		<dl>
			<dt> 状态：</dt>
